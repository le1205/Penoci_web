...
export const navConfig = [
  ...
  { title: 'About', s_title: 'Know more', path: paths.about.about },
  { title: 'Trust & Safety', s_title: 'Check our safety methods', path: paths.security.landing },
  { title: 'Press', s_title: 'Our presence', path: paths.affiliate.landing },
  { title: 'Contact', s_title: 'Get in touch', path: paths.contact.contact },
  // { title: 'faq', s_title: '', path: paths.docs },
  // { title: 'blog', s_title: '', path: paths.docs },
];
